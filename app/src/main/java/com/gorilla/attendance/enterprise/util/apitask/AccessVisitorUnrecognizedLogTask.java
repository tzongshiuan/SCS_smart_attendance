...
public class AccessVisitorUnrecognizedLogTask extends AsyncTask<Object, Integer, RecordsReplyModel> {

    public static final String TAG = "AccessVisitorUnrecognizedLogTask";

    IAccessVisitorUnrecognizedLogListener callback;
    ...
    protected RecordsReplyModel doInBackground(Object... params) {
        ...
        callback = (IAccessVisitorUnrecognizedLogListener) params[3];
...
//                jsonRecordsObj.put(RecordsModel.KEY_FACE_IMG, Base64.encodeToString(test,Base64.DEFAULT));
            ...
            LOG.D(TAG,"AccessUnrecognizedLogTask attendanceBean = " + attendanceBean);
...
//                        jsonErrorLogObj.put(ErrorLogsModel.KEY_FACE_IMG, "");
                    ...
                    LOG.D(TAG,"AccessUnrecognizedLogTask jsonErrorLogArr.toString() = " + jsonErrorLogArr.toString());
                }
            }
...
//                model = ApiResultParser.accessUnrecognizedLogParser(ApiAccessor.accessUnrecognizedLog(context, deviceToken, jsonErrorLogArr.toString()));
                ...
                LOG.E(TAG, "AccessUnrecognizedLogTask() - failed.", tr);
            }
        }else{
    ...
    protected void onPostExecute(RecordsReplyModel result) {
        ...
        if(callback != null)
            callback.onAccessVisitorUnrecognizedLog(result);
    }
