...
import com.gorilla.attendance.enterprise.ui.ScsMainActivity;
...
public class FDRControlManager {
    ...
    private FragmentActivity mScsMainActivity = null;
    ...
    public FDRControlManager(Context context, FragmentActivity mainActivity){
        mContext = context;
        mScsMainActivity = mainActivity;
        mInstance = this;
...
//            txtBox.append(deviceName + " " +  VID + ":" + PID + " " + manager.hasPermission(device) + "\n");
    ...
    public static FDRControlManager getInstance(Context context, FragmentActivity mainActivity){
        if(mInstance == null){
...
//            mFdrCtrl = null;
        ...
        // "/data/user/0/com.gorilla.attendance.enterprise.scs/files/Bin"
...
//                }
    ...
    public void startFdr(Handler fragmentCallback){
        LOG.D(TAG,"startFdr ");
...
//            mFdrCtrl.is
    ...
    public void stopFdr(Handler fragmentCallback){
    ...
    private FDRControl.IODTriggerResponseListener iodTrgrRespListener = new FDRControl.IODTriggerResponseListener() {
        ...
        public void onIODTriggerResponse(FDRControl.TriggerType trigger, IntelligentObjectDetector.Type_IODInfo iodInfo) {
            ...
            * */
            ...
            LOG.D(TAG,"mScsMainActivity.getSupportFragmentManager().findFragmentByTag(VideoFragment.TAG) = " + mScsMainActivity.getSupportFragmentManager().findFragmentByTag(VideoFragment.TAG));
            if(mScsMainActivity.getSupportFragmentManager().findFragmentByTag(VideoFragment.TAG) != null){
                VideoFragment videoFragment = (VideoFragment)mScsMainActivity.getSupportFragmentManager().findFragmentByTag(VideoFragment.TAG);
            ...
            if(trigger.equals(FDRControl.TriggerType.DETERMINED)){
                ...
                //show Identifying
//                mScsMainActivity.setIdentifyResult(mScsMainActivity.getString(R.string.identifying_the_face));
...
//                        mFragmentCallbackHandler.sendEmptyMessage(Constants.GET_FACE_FAIL);
                ...
                // show face forward
//                mScsMainActivity.setIdentifyResult(mScsMainActivity.getString(R.string.please_face_forward_the_camera));
            }
        }
...
//            } else {
//
//                Toast.makeText(ScsMainActivity.this, String.format("Search face event error %d.", respCode), Toast.LENGTH_SHORT)
//                        .show();
//            }
        }
