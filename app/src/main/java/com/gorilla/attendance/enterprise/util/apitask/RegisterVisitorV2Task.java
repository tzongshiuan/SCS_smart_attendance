...
public class RegisterVisitorV2Task extends AsyncTask<Object, Integer, RegisterReplyModel> {
    ...
    protected RegisterReplyModel doInBackground(Object... params) {
        ...
        callback = (IRegisterVisitorV2Listener) params[11];
...
//                    title, createTime, imageFormat, imageListJsonArr.toString()));
            ...
            model = ApiResultParser.registerVisitorV2Parser(ApiAccessor.registerVisitorV2(context, deviceToken, mobileNo, name, company,
                    title, createTime, imageFormat, imageListJsonArr.toString(), email, securityCode));
