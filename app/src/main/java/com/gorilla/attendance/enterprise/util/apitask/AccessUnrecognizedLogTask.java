...
public class AccessUnrecognizedLogTask extends AsyncTask<Object, Integer, RecordsReplyModel> {

    public static final String TAG = "AccessUnrecognizedLogTask";

    IAccessUnrecognizedLogListener callback;
    ...
    protected RecordsReplyModel doInBackground(Object... params) {
        ...
        callback = (IAccessUnrecognizedLogListener) params[3];
...
//                        jsonErrorLogObj.put(ErrorLogsModel.KEY_FACE_IMG, "");
    ...
    protected void onPostExecute(RecordsReplyModel result) {
        ...
        if(callback != null)
            callback.onAccessUnrecognizedLog(result);
    }
