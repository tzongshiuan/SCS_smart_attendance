...
/**
 * Created by kenyang on 2018/10/2.
 */
...
public class RegisterInputQRFragment extends BaseFragment {
    public static final String TAG = "RegisterInputQRFragment";
    ...
    private TextView mTxtRegisterInputQRTitle = null;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (mView == null) {
            mView = inflater.inflate(R.layout.register_input_qr_fragment, null);
        } else {
...
//        initView(mView);
    ...
    public void onResume() {
        ...
        if (mRegisterType == Constants.REGISTER_TYPE_EMPLOYEE) {
            mTxtRegisterInputQRTitle.setText(getString(R.string.txt_register_input_id));

        } else if (mRegisterType == Constants.REGISTER_TYPE_VISITOR) {
            mTxtRegisterInputQRTitle.setText(getString(R.string.txt_register_input_phone_number));
    ...
    private void initView() {
        mTxtRegisterInputQRTitle = (TextView) mView.findViewById(R.id.txt_qrcode_title);
...
//        intent.putExtra("SCAN_CAMERA_ID", -1);
    ...
    private BarcodeCallback mBarcodeViewCallback = new BarcodeCallback() {
        ...
        public void barcodeResult(BarcodeResult result) {
            ...
            mRegisterInputId = result.getText().toString();
            LOG.D(TAG, "mRegisterInputId = " + mRegisterInputId);
...
//                ApiUtils.searchUser(TAG, mContext, DeviceUtils.mDeviceName, "EMPLOYEE", mEdtInputId.getText().toString(), null, searchUserListener);
                ApiUtils.searchEmployee(TAG, mContext, DeviceUtils.mDeviceName, mRegisterInputId, searchEmployeeListener);
...
//                ApiUtils.searchUser(TAG, mContext, DeviceUtils.mDeviceName, "VISITOR", mEdtInputId.getText().toString(), null, searchUserListener);
                ...
                ApiUtils.searchVisitor(TAG, mContext, DeviceUtils.mDeviceName, mRegisterInputId, searchVisitorListener);
